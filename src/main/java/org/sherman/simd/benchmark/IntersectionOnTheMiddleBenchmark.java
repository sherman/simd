...
public class IntersectionOnTheMiddleBenchmark {
    private final Logger logger = LoggerFactory.getLogger(IntersectionOnTheMiddleBenchmark.class);
    private int[] data1;
    private int[] data2;
    private int[] data3;
    ...
    public void generateData() {
        // has intersection in the middle (element 1015), size 256
