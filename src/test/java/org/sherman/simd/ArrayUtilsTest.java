...
public class ArrayUtilsTest {
    ...
    @Test
    public void hasIntersectionVectorShuffling() {
        Assert.assertFalse(ArrayUtils.hasIntersectionVectorShuffling(
            new int[]{1, 100, 101, 201, 201, 202, 2000, 3000},
            new int[]{2, 102, 103, 203, 204, 205, 206, 207})
        );
        ...
        Assert.assertTrue(ArrayUtils.hasIntersectionVectorShuffling(
            new int[]{1, 2, 3, 4, 5, 6, 7, 9},
            new int[]{9, 10, 11, 12, 13, 14, 15, 16})
        );
